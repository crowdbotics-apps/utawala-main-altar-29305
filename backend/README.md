...
## Project Structure
    ...
    ├── utawala_main_altar_29305  # Django project configurations
...
1. Clone this repo and `cd utawala_main_altar_29305`
...
2. Clone this repo and `cd utawala_main_altar_29305`
